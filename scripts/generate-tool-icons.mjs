...
const RULES = [
  ...
  [/screenshot-auto-anonymizer|anonymizer|redact|censor-screenshot/i, "EyeOff"],
  ...
  [/hra|housing-rent|house-rent-allowance/i, "Landmark"],
  [/loan|mortgage|interest|compound|amortization|investment|roi|xirr|retirement|savings|salary|paycheck|tip|discount|sales-tax|vat|gst|profit|margin|markup|break-even|currency|exchange-rate|inflation|depreciation|net-worth|debt|credit|finance|tax|payment|emi|apr|sip|swp|systematic-withdrawal|cagr|mutual-fund|fd-calculator|fixed-deposit|ppf|epf|provident-fund|rd-calculator|recurring-deposit|lumpsum|lump-sum|nps|national-pension|gratuity|ssy|sukanya|scss|senior-citizen|nsc|national-savings/i, "DollarSign"],
  ...
  [/ats-resume|resume-checker|ats-check/i, "Clipboard"],
