...
const RULES = [
  ...
  [/rank-tracker|keyword-rank/i, "TrendingUp"],
  [/seo-audit|seo-content-score|heading-structure|nap-consistency|search-intent|keyword-difficulty|related-keywords|content-brief|ai-seo|ai-meta/i, "Search"],
