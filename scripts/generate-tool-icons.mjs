...
const RULES = [
  ...
  [/loan|mortgage|interest|compound|amortization|investment|roi|retirement|savings|salary|paycheck|tip|discount|sales-tax|vat|gst|profit|margin|markup|break-even|currency|exchange-rate|inflation|depreciation|net-worth|debt|credit|finance|tax|payment|emi|apr|sip|swp|systematic-withdrawal|cagr|mutual-fund|fd-calculator|fixed-deposit|ppf|provident-fund|rd-calculator|recurring-deposit|lumpsum|lump-sum/i, "DollarSign"],
