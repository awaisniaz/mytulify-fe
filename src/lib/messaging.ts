...
/** @deprecated Prefer TOTAL_BROWSER_TOOLS from catalog. */
export const CLIENT_TOOLS = TOTAL_BROWSER_TOOLS;
...
export const messaging = {
  ...
  siteDescription: `${TOTAL_TOOLS}+ online tools across ${TOTAL_CATEGORIES} categories. ${TOTAL_BROWSER_TOOLS}+ browser tools are free with no signup. AI & OCR (${TOTAL_AI_OCR_TOOLS} tools) include ${FREE_AI_DAILY_LIMIT} free runs per day — Pro adds unlimited AI and removes ads.`,

  heroBadge: `${TOTAL_TOOLS}+ tools · Free tier + Pro`,
  heroTitleLead: "Online tools for",
  heroSubtitle: `${TOTAL_BROWSER_TOOLS}+ browser tools free & unlimited. AI & OCR: ${FREE_AI_DAILY_LIMIT} runs/day on Free — Pro for unlimited & no ads.`,

  footerNote: `${TOTAL_BROWSER_TOOLS}+ browser tools free · Pro for unlimited AI`,

  homeValueFreeTitle: "Free tier",
  homeValueFreeDesc: `${TOTAL_BROWSER_TOOLS}+ browser tools · ${FREE_AI_DAILY_LIMIT} AI runs/day`,

  homeCtaSubtitle: `${TOTAL_BROWSER_TOOLS}+ tools work without signup. AI daily limits on Free — upgrade to Pro anytime.`,

  authSignupNote: "Account optional. Pro unlocks unlimited AI & no ads.",

  aboutIntro: `${TOTAL_TOOLS}+ online tools — ${TOTAL_BROWSER_TOOLS}+ run free in your browser; AI & OCR include a daily free allowance or unlimited with Pro.`,
  aboutPricingTitle: "Free & Pro",
  aboutPricingBody: `${TOTAL_BROWSER_TOOLS}+ browser tools stay free with no signup. AI & OCR tools allow ${FREE_AI_DAILY_LIMIT} runs per day on Free. Pro adds unlimited AI, OCR, and an ad-free experience.`,
