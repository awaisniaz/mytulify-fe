...
/* ------------------------------ EMI calculator ----------------------------- */
export { EmiCalculator } from "./finance-calcs";
...
/* ------------------------------ SIP Calculator ----------------------------- */
export { SipCalculator, CagrCalculator } from "./finance-calcs";

/* ------------------------------ FD Calculator ------------------------------ */
export { FdCalculator, fdMaturity } from "./finance-calcs";

/* ------------------------------ RD Calculator ------------------------------ */
export { RdCalculator, rdMaturity } from "./finance-calcs";

/* ------------------------------ PPF Calculator ----------------------------- */
export { PpfCalculator, ppfMaturity } from "./finance-calcs";
...
/* ------------------------------ SWP Calculator ----------------------------- */
export { SwpCalculator, swpProjection } from "./finance-calcs";

/* --------------------------- Lumpsum Calculator ---------------------------- */
export { LumpsumCalculator, lumpsumMaturity } from "./finance-calcs";
